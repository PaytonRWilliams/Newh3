...
<h1>Books by Author</h1>
  ...
  <div class="col-auto">
<?php
include "view-authors-with-books-newform.php";
?>
  </div>
</div>
...
?>
    ...
    <div class="row">
      ...
      <div class="col-auto">
<?php
include "view-authors-with-books-editform.php";
?>
      </div>
      <div class="col-auto">
...
?>
      ...
      <p class="card-text"><small class="text-body-secondary">Office: <?php echo $author['gender']; ?></small></p>
    </div>
  </div>
<?php
}
