...
<button type="button" class="btn" data-bs-toggle="modal" data-bs-target="#newBookAuthorModal">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h1 class="modal-title fs-5" id="newBookAuthorModalLabel">New book author</h1>
...
?>
          ...
          <div class="mb-3">
            <label for="bid" class="form-label">Book</label>
