  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="mb-3">
          <label for="aGender<?php echo $author['author_id']; ?>" class="form-label">Author Gender</label>
          <input type="text" class="form-control" id="aGender<?php echo $author['author_id']; ?>" name= "aGender" value="<?php echo $author['author_gender']; ?>">
